...
CREATE TABLE materials (
  ...
  subject_name TEXT NOT NULL,          -- "PS", "MFCS", "DS", "DBMS", "PC", "CSA"
...
-- PS (Probability and Statistics) - Notes with units
INSERT INTO materials (regulation, branch, year, sem, subject_name, credits, material_type, material_name, url, unit) VALUES
  (22, 'IT', 2, 1, 'PS', 4, 'Notes', 'Unit 1 Notes', 'https://drive.google.com/file/d/12mKSFC5opEUJYMqPt7BgCYmDaBMMZBJ2/view', 1),
  (22, 'IT', 2, 1, 'PS', 4, 'Notes', 'Unit 1 Notes (v2)', 'https://drive.google.com/file/d/1GBoXmHonqUjbe_sHK4G55_axz5--k3Mq/view', 1),
  (22, 'IT', 2, 1, 'PS', 4, 'Notes', 'Unit 2 Notes', 'https://drive.google.com/file/d/1qI1nEkzck1P55s4Q6r9dNeDhfhL0lRR5/view', 2);

-- Same subject, different branches (same data, different branch)
INSERT INTO materials (regulation, branch, year, sem, subject_name, credits, material_type, material_name, url, unit) VALUES
  (22, 'CSE', 2, 1, 'PS', 4, 'Notes', 'Unit 1 Notes', 'https://drive.google.com/file/d/12mKSFC5opEUJYMqPt7BgCYmDaBMMZBJ2/view', 1),
  (22, 'DS', 2, 1, 'PS', 4, 'Notes', 'Unit 1 Notes', 'https://drive.google.com/file/d/12mKSFC5opEUJYMqPt7BgCYmDaBMMZBJ2/view', 1);
...
INSERT INTO materials (regulation, branch, year, sem, subject_name, credits, material_type, material_name, url) VALUES
  (22, 'IT', 2, 1, 'PS', 4, 'Question Bank', 'Question Bank', 'https://drive.google.com/file/d/1PjJbV2jt3CvIgmCadRZh8sjOan_UhpVy/view');

-- YouTube Playlist (no unit - opens directly)
INSERT INTO materials (regulation, branch, year, sem, subject_name, credits, material_type, material_name, url) VALUES
  (22, 'IT', 2, 1, 'PS', 4, 'YouTube Videos', 'Complete Playlist', 'https://youtube.com/playlist?list=PLcejZ7Xxx9YNJH5X_1y-X2_vdihH4MjWF');

-- PYQs with years (DS = Data Structures subject)
INSERT INTO materials (regulation, branch, year, sem, subject_name, credits, material_type, material_name, url, year_optional) VALUES
  (22, 'IT', 2, 1, 'DS', 3, 'PYQs', 'Mid-1 Paper', 'https://drive.google.com/file/d/xxxxx/view', '2024'),
  (22, 'IT', 2, 1, 'DS', 3, 'PYQs', 'Mid-1 Paper', 'https://drive.google.com/file/d/xxxxx/view', '2023');
...
-- FROM materials 
-- WHERE regulation = 22 AND branch = 'IT' AND year = 2 AND sem = 1 AND subject_name = 'PS'
-- ORDER BY material_type;

-- Get available units for Notes/YouTube
-- SELECT DISTINCT unit 
-- FROM materials 
-- WHERE subject_name = 'PS' AND material_type = 'Notes' AND unit IS NOT NULL
-- ORDER BY unit;

-- Get available years for PYQs
-- SELECT DISTINCT year_optional 
-- FROM materials 
-- WHERE subject_name = 'DS' AND material_type = 'PYQs' AND year_optional IS NOT NULL
-- ORDER BY year_optional DESC;

-- Get all materials for a specific combo
-- SELECT * FROM materials 
-- WHERE subject_name = 'PS' 
